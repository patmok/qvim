...
syn keyword kLocal a0
syn keyword kLocal a1
syn keyword kLocal a2
syn keyword kLocal a3
syn keyword kLocal b0
syn keyword kLocal b1
syn keyword kLocal b2
syn keyword kLocal b3
syn keyword kLocal c0
syn keyword kLocal c1
syn keyword kLocal c2
syn keyword kLocal c3
syn keyword kLocal d0
syn keyword kLocal d1
syn keyword kLocal d2
syn keyword kLocal d3
syn keyword kLocal e0
syn keyword kLocal e1
syn keyword kLocal e2
syn keyword kLocal e3
syn keyword kLocal f0
syn keyword kLocal f1
syn keyword kLocal f2
syn keyword kLocal f3
syn keyword kLocal g0
syn keyword kLocal g1
syn keyword kLocal g2
syn keyword kLocal g3
syn keyword kLocal h0
syn keyword kLocal h1
syn keyword kLocal h2
syn keyword kLocal h3
syn keyword kLocal i0
syn keyword kLocal i1
syn keyword kLocal i2
syn keyword kLocal i3
syn keyword kLocal j0
syn keyword kLocal j1
syn keyword kLocal j2
syn keyword kLocal j3
syn keyword kLocal k0
syn keyword kLocal k1
syn keyword kLocal k2
syn keyword kLocal k3
syn keyword kLocal l0
syn keyword kLocal l1
syn keyword kLocal l2
syn keyword kLocal l3
syn keyword kLocal m0
syn keyword kLocal m1
syn keyword kLocal m2
syn keyword kLocal m3
syn keyword kLocal n0
syn keyword kLocal n1
syn keyword kLocal n2
syn keyword kLocal n3
syn keyword kLocal o0
syn keyword kLocal o1
syn keyword kLocal o2
syn keyword kLocal o3
syn keyword kLocal p0
syn keyword kLocal p1
syn keyword kLocal p2
syn keyword kLocal p3
syn keyword kLocal q0
syn keyword kLocal q1
syn keyword kLocal q2
syn keyword kLocal q3
syn keyword kLocal r0
syn keyword kLocal r1
syn keyword kLocal r2
syn keyword kLocal r3
syn keyword kLocal s0
syn keyword kLocal s1
syn keyword kLocal s2
syn keyword kLocal s3
syn keyword kLocal t0
syn keyword kLocal t1
syn keyword kLocal t2
syn keyword kLocal t3
syn keyword kLocal u0
syn keyword kLocal u1
syn keyword kLocal u2
syn keyword kLocal u3
syn keyword kLocal v0
syn keyword kLocal v1
syn keyword kLocal v2
syn keyword kLocal v3
syn keyword kLocal w0
syn keyword kLocal w1
syn keyword kLocal w2
syn keyword kLocal w3
syn keyword kLocal x0
syn keyword kLocal x1
syn keyword kLocal x2
syn keyword kLocal x3
syn keyword kLocal y0
syn keyword kLocal y1
syn keyword kLocal y2
syn keyword kLocal y3
syn keyword kLocal z0
syn keyword kLocal z1
syn keyword kLocal z2
syn keyword kLocal z3
...
syn keyword qLib \.Q\.bvfp
syn keyword qLib \.Q\.bvi
...
syn keyword qLib \.Q\.jp
syn keyword qLib \.Q\.k
syn keyword qLib \.Q\.l
syn keyword qLib \.Q\.ld
syn keyword qLib \.Q\.li
syn keyword qLib \.Q\.lo
syn keyword qLib \.Q\.lu
syn keyword qLib \.Q\.n
syn keyword qLib \.Q\.nA
syn keyword qLib \.Q\.nct
syn keyword qLib \.Q\.nv
syn keyword qLib \.Q\.objp
